...
enum HabitType: String, Codable, CaseIterable, Identifiable {
    ...
    var howItWorksShort: String {
        switch self {
        case .madeBed: return "Snap a photo and AI verifies it's made"
        case .sunlightExposure: return "Take a photo outside, AI verifies the daylight"
        case .hydration: return "Snap your water and AI confirms you're hydrated"
        ...
        case .healthyBreakfast: return "Snap your breakfast and AI checks if it's healthy"
        case .morningJournal: return "Show your journal and AI verifies you wrote"
        case .vitamins: return "Snap your vitamins and AI confirms your supplements"
        case .skincare: return "Snap your skincare and AI verifies your routine"
        case .mealPrep: return "Show your prep and AI confirms you're ready"
        case .touchGrass: return "Snap a photo outside, AI verifies you touched grass"
        case .gratitude: return "Write what you're grateful for"
        case .noPhoneFirst30: return "Hold to confirm you stayed phone-free"
        case .dailyPlanning: return "Write out your priorities for the day"
